...
var appWidth = "47%";
var gridWidth = "100%";
var btnHeight = width/1.618;
var appHeight = btnHeight*2;
...
function makeGrid(){
	...
	{
		buttons[btnTypeIdx] = /*btnHolder*/mainContent.append('div').style('width', width + 'px').style('height', btnHeight + 'px').style('margin-top', '10px').style('float', 'left').style('margin-left', '2%').attr('id', 'button' + btnTypeIdx).style('background-color', '#AAAAAA').style('cursor', 'pointer'); 
...
function buttonClicked(id) {
	...
	{	
		...
		var appContent = apps.append('div').style('background-color', '#626262').attr('id', 'appContent' + id).transition().duration(1000).style('height', appHeight + 'px');
		/*
