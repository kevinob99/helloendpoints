...
var app1 = mainContent.append('div').style('width', '47%').style('margin-top', '10px').attr('class', 'nameHeader').style('color', baseHcl.toString()).style('float', 'right').style('padding', '7px').attr('id', 'app1').style('display', 'none').style('margin-right', '1%'); //style('background-color', '#626262').
...
var app2 = mainContent.append('div').style('width', '47%').style('margin-top', '10px').attr('class', 'nameHeader').style('color', baseHcl.toString()).style('float', 'right').style('padding', '7px').attr('id', 'app2').style('display', 'none').style('margin-left', '1%'); //style('background-color', '#626262').
...
function buttonClicked(id) {
	...
	{
		appId = 1;
		btnHolder.transition().duration(1000).attr('width', x/5).style('width', '49%'); //.style('background-color', '#626262');
		//var app1 = d3.select('#app1');
		//var app1Title = d3.select('#appTitle1');
	...
	else if ((app1.style('display') != 'none') && (app2.style('display') == 'none')) //(btnHolderWidth > x*.2)
	{
		...
		btnHolder.transition().duration(1000).style('opacity', '0').remove();
...
function closeApp(idx) {
	...
	//btnHolderDisplay = btnHolder.style('display');
	// btnHolderWidth = btnHolder.style('width');
	if (btnHolder[0][0].parentElement == null)
	{
		//makeGrid();
		...
		btnHolder.style('display', 'block').style('width', '49%');
	}
	else
	{
...
function showApp() {
	...
	app.style('display', 'block'); //.transition().duration(500).style('height', '100%');
}
/* ********************************************************************/
